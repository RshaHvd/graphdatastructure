...
object AddNewNodesAndEdgesBenchmark1MNodes10KEdges {

  @State(Scope.Thread)
  @BenchmarkMode(Array(Mode.AverageTime))
  @OutputTimeUnit(TimeUnit.MILLISECONDS)
  class AddNewNodesALArray1M10KBenchmark {
  ...
  @BenchmarkMode(Array(Mode.AverageTime))
  @OutputTimeUnit(TimeUnit.MILLISECONDS)
  class AddNewNodesALMap1M10KBenchmark {
  ...
  @BenchmarkMode(Array(Mode.AverageTime))
  @OutputTimeUnit(TimeUnit.MILLISECONDS)
  class AddNewNodesALTree1M10KBenchmark {
  ...
  @BenchmarkMode(Array(Mode.AverageTime))
  @OutputTimeUnit(TimeUnit.MILLISECONDS)
  class AddNewNodesCSRMap1M10KBenchmark {
  ...
  @BenchmarkMode(Array(Mode.AverageTime))
  @OutputTimeUnit(TimeUnit.MILLISECONDS)
  class AddNewNodesCSRTree1M10KBenchmark {
