package hvd.edu.benchmark.jmh.write.updateEdges.nodes100k
...
object UpdateEdgesBenchmark100KNodes100KEdges {

  @State(Scope.Thread)
  @BenchmarkMode(Array(Mode.AverageTime))
  @OutputTimeUnit(TimeUnit.MILLISECONDS)
  class UpdateEdgesALArray100K100KBenchmark {
  ...
  @BenchmarkMode(Array(Mode.AverageTime))
  @OutputTimeUnit(TimeUnit.MILLISECONDS)
  class UpdateEdgesALMap100K100KBenchmark {
  ...
  @BenchmarkMode(Array(Mode.AverageTime))
  @OutputTimeUnit(TimeUnit.MILLISECONDS)
  class UpdateEdgesALTree100K100KBenchmark {
  ...
  @BenchmarkMode(Array(Mode.AverageTime))
  @OutputTimeUnit(TimeUnit.MILLISECONDS)
  class UpdateEdgesCSRMap100K100KBenchmark {
  ...
  @BenchmarkMode(Array(Mode.AverageTime))
  @OutputTimeUnit(TimeUnit.MILLISECONDS)
  class UpdateEdgesCSRTree100K100KBenchmark {
